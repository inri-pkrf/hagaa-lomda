...
export const unitFourChecklist = {
  items: [
    '**כל הכבוד!** סיימתם את יחידת הלימוד הרביעית במסגרת הכשרתכם לתפקיד ממוני הג"א. ביחידה זו למדתם להבחין בין "שעת התקפה" ל"מצב מיוחד בעורף". כמו כן, למדתם מהן הפעולות שאתם נדרשים לקדם במעבר לשגרת חירום ומהן הפעולות המיידיות שאתם נדרשים לבצע בהתרחש אירוע במפעל. ',
  ],
