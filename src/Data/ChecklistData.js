...
export const unitOneChecklist = {
  ...
  image: `${process.env.PUBLIC_URL}/assets/General/check-list-data/BuildingUnit1.png`,
...
export const unitTwoChecklist = {
  ...
  image: `${process.env.PUBLIC_URL}/assets/General/check-list-data/BuildingUnit2.png`,
...
export const unitTwoSub1Checklist = {
  items: [
    "תוכנית התגוננות – תכנון מענה מיגוני לכל עובד וקהל (עמידה בזמן התרעה)",
  ...
  image: `${process.env.PUBLIC_URL}/assets/General/check-list-data/Door-check-list.png`,
  checklistImg: `${process.env.PUBLIC_URL}/assets/General/check-list-data/CheckListUnit2.png`,
  color: "#56C3A9",
...
export const unitTwoSub4Checklist = {
  items: [
    ...
    "להדריך ולתרגל את העובדים במפעל בדבר התנהגות באירוע שרפה",
  ],
  image: `${process.env.PUBLIC_URL}/assets/General/check-list-data/Door-check-list.png`,
  checklistImg: `${process.env.PUBLIC_URL}/assets/General/check-list-data/CheckListUnit2.png`,
  color: "#56C3A9",
...
export const unitThreeChecklist = {
  items: [
    '**כל הכבוד!** סיימתם את יחידת הלימוד השלישית במסגרת הכשרתכם לתפקיד ממונה הג"א. ביחידה זו למדתם את העקרונות לגבש ולהכשיר את צוותי החירום במפעל, לתכנן מפ"ל ולהיערך למשאבים ולכוח אדם הדרוש בחירום. בנוסף, הכרתם את מבנה ותכולת תיק החירום, לצורך כתיבתו במסגרת תפקידכם.  נאחל לכם המשך למידה מהנה ופורייה גם ביחידות הלימוד הבאות. בהצלחה!',
  ],
  image: `${process.env.PUBLIC_URL}/assets/General/check-list-data/BuildingUnit3.png`,
...
export const unitThreeSub4Checklist = {
  items: [
    ...
    "לוודא קיומה של תוכנית להשלמת הפערים, המתואמת עם הגורמים הרלוונטיים",
...
export const unitFourChecklist = {
  items: [
    '**כל הכבוד!** סיימתם את יחידת הלימוד הרביעית במסגרת הכשרתכם לתפקיד ממונה הג"א. ביחידה זו למדתם להבחין בין "שעת התקפה" ל"מצב מיוחד בעורף". כמו כן, למדתם מהן הפעולות שאתם נדרשים לקדם במעבר לשגרת חירום ומהן הפעולות המיידיות שאתם נדרשים לבצע בהתרחש אירוע במפעל. ',
  ],
  image: `${process.env.PUBLIC_URL}/assets/General/check-list-data/BuildingUnit4.png`,
