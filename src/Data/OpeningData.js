    ...
    text: (
      <>
        <ul>
          ...
          <li>לתאר את צרכי האוכלוסייה בארגון או המפעל שלך</li>
  ...
  UnitFour: {
    ...
    text: (
      <>
        <ul>
          <b>בסיום תדעו:</b>
          <li>להבחין בין המצבים המשפטיים "שעת התקפה" ו- "מצב מיוחד בעורף"</li>
          <li>מה המשימות הנדרשות לקידום המוכנות במעבר משגרה לחירום</li>
          <li>לתאר את סדר הפעולות באירוע חירום במפעל</li>
        </ul>
      </>
    ),
    colors: {
