  ...
  const content = {
    1: {
      ...
      paragraphs: [
        ...
        { text: "ניתוח השטח ומעטפת מתקן (פריפריה)." },
        { text: "פירוט החומרים המסוכנים במפעל." },
        { text: "הערכת סיכונים." },
        { text: "פירוט התפוקות והשירות שהמפעל נתון בחירום." },
        {
    ...
    2: {
      ...
      paragraphs: [
        ...
        {
          text: "היכן אמצעי ההתרעה במפעל, אם קיימים? אם לא- יש לקבוע כיצד מתקבלת ההתרעה בזמן אמת.",
        },
        {
        ...
        { text: "הציוד הנדרש למרחב המוגן, לרבות מעקב אחרי מועדי ריענון." },
        {
    ...
    3: {
      ...
      paragraphs: [
        ...
        {
          text: "פירוט תחומי אחריות של כל צוות וסדר פעולות (נקודת כינוס, תדריך הפעל וכו').",
        },
        { text: "פירוט כוח אדם בצוותים (לרבות מעקב אחר הכשרות)." },
        { text: "פירוט מיקום הציוד שקיים לכל צוות, לרבות מעקב אחר הדרכות." },
    ...
    4: {
      ...
      paragraphs: [
        ...
        { text: "ייצור, שיווק ואחסון התפעול בשעת חירום." },
        ...
        >
          ...
          {id === "2" && (
            <strong className="UsesFactoryFileExplanations-subText">
              * התיק יאגד בתוכו את התוכניות לטיפול בשריפה, חומ"ס וכו' בהתאם
