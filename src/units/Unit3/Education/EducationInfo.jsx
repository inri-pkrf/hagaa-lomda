...
function EducationInfo() {
  return (
    <InfoPageBase
      ...
      sliderColor="#FFB356"
      boxes={[
        { type: "box", text: "מסגרת לטיפול בילדי העובדים החיוניים עד גיל 12." },
        { type: "headline", text: "למה זה חשוב?" },
        {
          type: "box",
          text: "הקמת מסגרות לילדי העובדים החיוניים במפעל או במוסד תאפשר בזמן חירום רציפות והמשכיות של העובדים החיוניים במפעל.",
        },
      ]}
      sliderImages={[
