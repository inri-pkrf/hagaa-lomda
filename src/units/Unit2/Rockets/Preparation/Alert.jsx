...
const PAGE5_MESSAGES = [
  ...
  },
  {
    ...
    intro: [
      ...
      "**לפיכך ישנם מקרים בהם תתקבל הנחיה מקדימה אך לא תתקבל לאחריה התרעה (אזעקה)**",
    ],
    checklist: null,
  },
  {
    ...
    <div className="alert-wrapper">
      ...
      {page === 3 && (
        <div id="alert-page2">
          ...
          <p id="alert-sub-text3">משימתך כממונה הג"א - בדיקת כיסוי</p>
          <ol id="alert-list2">
            <li>יש לוודא כיסוי ההתרעה בכל שטח המפעל</li>
            <li>אם נדרש, יש לתכנן אמצעי התרעה משלימה</li>
            <li>בעת הפעלת ההתרעה – יש לבחון כיסוי מלא</li>
