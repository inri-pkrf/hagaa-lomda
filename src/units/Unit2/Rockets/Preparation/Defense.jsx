    ...
    <>
      {page === 1 && (
        <div>
          ...
          <img src={`${process.env.PUBLIC_URL}/assets/UnitTwoImgs/defense-icon.png`} alt="Siren" id='alert-defense-icon'/>
          ...
          <a href="https://www.oref.org.il/heb/life-saving-guidelines/rocket-and-missile-attacks" target="_blank" rel="noopener noreferrer" id='website-link'>
