...
const outsideSteps = [
  ...
  {
    id: "lamp",
    text: "ווידוא תקינות תאורת הפנים והחוץ.",
    top: "14%",
    left: "52%",
    zIndex: 1,
  },
...
מיכל מים (5 ליטרים ל-1 מטר מרובע). \nכמו כן, יש לוודא נקיונם של המיכלים אחת לחודש.`,
    top: "59%",
    left: "62%",
    zIndex: 6,
  },
...
function BuildingMaintenance() {
  ...
  const getPopupContent = () => {
    if (isIntro) {
      return {
        text: "כממונה הג”א עלייך לוודא שאחראי צוות אחזקת מבנים מבצע מספר בדיקות. \nיש ללחוץ על האלמנטים המהבהבים כדי ללמוד על הבדיקות השונות.",
        btn: "התחלה",
      };
    }
