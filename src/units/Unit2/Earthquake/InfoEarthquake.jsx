...
function InfoEarthquake() {
  ...
  const sliderImages = [
    ...
    `${process.env.PUBLIC_URL}/assets/UnitTwoImgs/earthquake/earthquake3.png`,
        ...
        <div className="sub-page-text-section">
          ...
          <div className="text-item">
            ...
            <p style={{ maxWidth: '800px' }}>
              <strong>רעידת אדמה</strong> היא תופעת טבע שכיחה בכדור הארץ. באזורים מיושבים ובנויים גורמת רעידת אדמה לרוב לנזק רב בנפש וברכוש, בהתאם לעוצמת הרעש, המרחק ממוקד הרעש, איכות הבנייה וסוג הסלע עליו המבנה ניצב.
            </p>
          </div>
          ...
          <div className="text-item">
            <div className="text-decorator"></div>
            <p style={{ maxWidth: '800px' }}>
              <strong>נזק ישיר:</strong> קריסת מבנים, פגיעות בתשתיות (כבישים, גשרים, חשמל, מים, תקשורת) ופגיעות בנפש (הרוגים, פצועים, לכודים, נעדרים, חסרי קורת גג).
            </p>
          </div>
          ...
          <div className="text-item">
            <div className="text-decorator"></div>
            <p style={{ maxWidth: '800px' }}>
              <strong>נזקי משנה:</strong> שריפות, דליפות גז או חומרים מסוכנים, הצפות מצינורות שהתבקעו, מפולות וסחף קרקע, פגיעה בשרשרת אספקה ושיבוש שגרת החיים.
            </p>
          </div>
