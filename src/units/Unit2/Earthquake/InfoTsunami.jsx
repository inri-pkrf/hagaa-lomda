...
function InfoTsunami() {
  return (
    <InfoPageBase
      ...
      boxes={[
        "צונמי (נחשול רעש) הוא תופעה של גלי ים גדולים המתפרצים בעוצמה רבה אל תוך חופי הים. בישראל יתכן צונמי כתוצאה מרעידת אדמה בלב-ים או כתוצאה מרעידת אדמה בפנים הארץ.",
