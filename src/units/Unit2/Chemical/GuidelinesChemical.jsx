  ...
  const behaviorData = [
    {
      ...
      title: "שטח פתוח",
      alt: "שטח פתוח",
      text: "יש להיכנס מיד למבנה ולסגור את הדלתות והחלונות. \nאין לצאת מהמבנה עד לקבלת הודעה על סיום האירוע. \nאם לא ניתן להיכנס למבנה - יש להתרחק ככל האפשר מאזור האירוע",
    },
    {
      id: "building",
      img:
      ...
      {showPopup && (
        <div className="chemical-popup-overlay">
          <div className="chemical-popup-content">
            ...
            <p>
              עליכם לעבור עם העכבר מעל התמונות, כדי ללמוד על התנהגות נכונה
      ...
      <div className="behavior-grid">
        ...
        <div className="grid-item-chemical text-container">
          <p>
            ...
            על כל אחת מהתמונות כדי לחשוף את ההנחיות במקומות השונים.
          </p>
        </div>
      </div>
    </div>
