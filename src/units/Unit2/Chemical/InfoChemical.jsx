...
function InfoChemical() {
  return (
    <InfoPageBase
      ...
      boxes={[
        `אירוע חומ"ס הוא אירוע של אובדן שליטה על חומר מסוכן.`,
        ...
        `אירוע חומ"ס עלול להשפיע על שטח המפעל או בהשפעה רחבה על האוכלוסייה (בשכונות מגורים סמוכות ולכן הן יסווגו כ"מסוכנות לאוכלוסייה").`,
      ]}
      sliderImages={[
