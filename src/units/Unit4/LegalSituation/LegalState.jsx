  ...
  return (
    <div className="LegalState-container">
      ...
      <p id="LegalState-text1">
        פרק זמן התלוי בהכרזה של הדרג המדיני.<br></br> וכולל רציפות - הנחיה רציפה
        בהתאם לאישור הדרג המדיני.<br></br> תיחום המרחב - גם כן נקבע על ידי הדרג
        המדיני. <br></br> וריתוק משקי - בסמכות שר העבודה להורות על ריתוק עובדים.
      </p>
