  ...
  return (
    <div className="LegalState-container">
      ...
      <p id="LegalState-text1">
        פרק זמן תלוי בהכרזה של הדרג המדיני.<br></br> רציפות - הנחיה רציפה בהתאם
        לאישור הדרג המדיני.<br></br> תיחום המרחב - נקבע על ידי הדרג המדיני. <br></br> ריתוק
        משקי - בסמכות שר העבודה להורות על ריתוק עובדים.
      </p>
      <p id="LegalState-text2">
        אחריות פיקוד ושליטה על האירוע - של צה"ל או פיקוד העורף לאחר הכרזה של הממשלה -
        ישנה הפעלה אוטומטית של פרקי הזמן של מערך המל"ח (משק לשעת חירום)
        <div>
          המקנה בין היתר סמכות לצה"ל/פקע"ר לפרסם הנחיות התגוננות
          לאוכלוסייה למשק.
        </div>
      </p>
      <img
