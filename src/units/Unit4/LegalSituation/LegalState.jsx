  ...
  return (
    <div className="LegalState-container">
      ...
      <p id="LegalState-text1">
        ...
        לאישור הדרג המדיני.<br></br> תיחום המרחב - נקבע על ידי הדרג המדיני.{" "}
        <br></br> ריתוק משקי - בסמכות שר העבודה להורות על ריתוק עובדים.
      </p>
      <p id="LegalState-text2">
        אחריות פיקוד ושליטה על האירוע - של צה"ל או פיקוד העורף לאחר הכרזה של
