...
function IntroUnitOne() {
  ...
  const [doorImage, setDoorImage] = useState(`${process.env.PUBLIC_URL}/assets/General/Doors/Doors.jpg`);
  ...
  useEffect(() => {
    window.dispatchEvent(new CustomEvent('setNextBtnDisabled', { detail: !allDoorsFinished }));
  ...
  const handleSignOneClick = () => {
    setDoorImage(`${process.env.PUBLIC_URL}/assets/General/Doors/DoorOneOpen.jpg`);
    setOpeningSign(1);
  ...
  const handleSignTwoClick = () => {
    setDoorImage(`${process.env.PUBLIC_URL}/assets/General/Doors/DoorTwoOpen.jpg`);
    setOpeningSign(2);
  ...
  const handleSignThreeClick = () => {
    setDoorImage(`${process.env.PUBLIC_URL}/assets/General/Doors/DoorThreeOpen.jpg`);
    setOpeningSign(3);
  ...
  const handleSignFourClick = () => {
    setDoorImage(`${process.env.PUBLIC_URL}/assets/General/Doors/DoorFourOpen.jpg`);
    setOpeningSign(4);
      ...
      <div className='door-signs-UnitOne'>
        {openingSign !== 1 && (
          <div className='door-sign-UnitOne-first' onClick={!openingSign ? handleSignOneClick : undefined} style={{ cursor: 'pointer' }}>
            ...
            <img src={`${process.env.PUBLIC_URL}/assets/General/Doors/DoorsSigns/DoorSignOne.png`} alt="Sign 1" className='title-img'/>
          </div>
        )}
        {openingSign !== 2 && (
          <div className={`door-sign-UnitOne-second ${!canEnterSecond ? 'disabled' : ''}`} onClick={!openingSign && canEnterSecond ? handleSignTwoClick : undefined}>
            ...
            <img src={`${process.env.PUBLIC_URL}/assets/General/Doors/DoorsSigns/DoorSignTwo.png`} alt="Sign 2" className='title-img'/>
          </div>
        )}
        {openingSign !== 3 && (
          <div className={`door-sign-UnitOne-third ${!canEnterThird ? 'disabled' : ''}`} onClick={!openingSign && canEnterThird ? handleSignThreeClick : undefined}>
            ...
            <img src={`${process.env.PUBLIC_URL}/assets/General/Doors/DoorsSigns/DoorSignThree.png`} alt="Sign 3" className='title-img'/>
          </div>
        )}
        {openingSign !== 4 && (
          <div className={`door-sign-UnitOne-fourth ${!canEnterFourth ? 'disabled' : ''}`} onClick={!openingSign && canEnterFourth ? handleSignFourClick : undefined}>
            ...
            <img src={`${process.env.PUBLIC_URL}/assets/General/Doors/DoorsSigns/DoorSignFour.png`} alt="Sign 4" className='title-img'/>
          </div>
        )}
      </div>

      {finishedChapters.unitOneFirst && <img className='doorOneDone UnitOneDoors' src={`${process.env.PUBLIC_URL}/assets/General/Doors/DoorsDone/DoorOneDone.png`} alt="1" />}
      {finishedChapters.unitOneSecond && <img className='doorTwoDone UnitOneDoors' src={`${process.env.PUBLIC_URL}/assets/General/Doors/DoorsDone/DoorTwoDone.png`} alt="2" />}
      {finishedChapters.unitOneThird && <img className='doorThreeDone UnitOneDoors' src={`${process.env.PUBLIC_URL}/assets/General/Doors/DoorsDone/DoorThreeDone.png`} alt="3" />}
      {finishedChapters.unitOneFourth && <img className='doorFourDone UnitOneDoors' src={`${process.env.PUBLIC_URL}/assets/General/Doors/DoorsDone/DoorFourDone.png`} alt="4" />}

      <button className='ShortcutButton' id='ShortcutButton1-one' onClick={() => {
        sessionStorage.setItem('unitOne-first', 'finished');
        setFinishedChapters(prev => ({ ...prev, unitOneFirst: true }));
      }}>כפתור קיצור- דלת 1</button>
      <button className='ShortcutButton' id='ShortcutButton2-one' onClick={() => {
        sessionStorage.setItem('unitOne-second', 'finished');
        setFinishedChapters(prev => ({ ...prev, unitOneSecond: true }));
      }}>כפתור קיצור- דלת 2</button>
      <button className='ShortcutButton' id='ShortcutButton3-one' onClick={() => {
        sessionStorage.setItem('unitOne-third', 'finished');
        setFinishedChapters(prev => ({ ...prev, unitOneThird: true }));
      }}>כפתור קיצור- דלת 3</button>
      <button className='ShortcutButton' id='ShortcutButton4-one' onClick={() => {
        sessionStorage.setItem('unitOne-fourth', 'finished');
        setFinishedChapters(prev => ({ ...prev, unitOneFourth: true }));
      }}>כפתור קיצור- דלת 4</button>
