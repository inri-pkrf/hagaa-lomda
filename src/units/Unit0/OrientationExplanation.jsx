...
const steps = [
  ...
  {
    target: ".pg-container",
    text: "זהו סרגל ההתקדמות להצגת אחוזי ההשלמה של השיעור הדיגיטלי, כל יחידה שווה 25%.",
    popupPosition: "bottom",
    openSidebar: false,
    arrowDirection: "up",
  },
  {
    target: ".toggle-tab",
    text: "בלחיצה על הלשונית ייפתח תפריט הניווט הצדדי המאפשר מעבר מהיר בין חלקי התוכן.",
    popupPosition: "left",
    openSidebar: false,
  ...
  },
  {
    ...
    text: `בתחתית התפריט, נמצאים כפתור "מי אנחנו" לפרטים על צוות האפיון והפיתוח של השיעור הדיגיטלי, וכפתור "משוב", המקשר לטופס לשאלון על התוכן הלימודי.`,
    popupPosition: "left",
    openSidebar: true,
    arrowDirection: "right",
  },
