        ...
        {step === 1 && (
          <div className="step-content">
            <p className="InfoLomda-par3" id="pay-attention-step2">
              ...
              מוסדות ואימון עובדיהם <br />
              (התשי"א - 1951, התשל"ג - 1973) <br />
              נדרש למנות מנהלים / ות לענייני התגוננות אזרחית (ממונה הג"א) במקרים
              הבאים:
            </p>
            ...
            >
              ...
              בעל מפעל מוסדר ימנה מבין עובדיו
              <br /> מנהל / ת או מנהלים / ות לענייני התגוננות אזרחית במפעלו או
              בכל חלק ממנו,
              <br /> בהתאם להוראות מפקד הג״א מחוזי.
            </div>
          </div>
        )}
